...
main (int argc, char** argv) 
{
  ...
  psplash_fb_draw_image (fb, 
			 (fb->width  - OPENHAB_IMG_WIDTH)/2, 
#if PSPLASH_IMG_FULLSCREEN
			 (fb->height - OPENHAB_IMG_HEIGHT)/2,
#else
			 (fb->height * PSPLASH_IMG_SPLIT_NUMERATOR
			  / PSPLASH_IMG_SPLIT_DENOMINATOR - OPENHAB_IMG_HEIGHT)/2,
#endif
			 OPENHAB_IMG_WIDTH,
			 OPENHAB_IMG_HEIGHT,
			 OPENHAB_IMG_BYTES_PER_PIXEL,
			 OPENHAB_IMG_ROWSTRIDE,
			 OPENHAB_IMG_RLE_PIXEL_DATA);
